...
#################fs example_cp.cp -n -phasefiles example_cp.phase -recombfiles example_cp.recombfile -createid example_cp.ids -s1minsnps 5000 -s3iters 10000 -s4iters 10000 -go
