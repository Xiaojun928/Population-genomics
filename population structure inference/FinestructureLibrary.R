...
## makes purple/red/yellow colour scheme, adding rgb(final) if not null
	#tmp<-c(rev(rgb(seq(1-colby,0,-colby),0,1.0)),rev(rgb(1,0,seq(colby,1,colby))),rev(rgb(1,seq(1,0,-colby),0)))
	#red/yellow
  tmp<-c(rev(rgb(1,0,seq(colby,1,colby))),rev(rgb(1,seq(1,0,-colby),0)))
